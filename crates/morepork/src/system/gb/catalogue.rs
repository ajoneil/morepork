...
pub static CPU: SubsystemDef = SubsystemDef {
    ...
    layers: &[
        ...
        (Layer::Internal, &[field!("bus_addr", u16)]),
        (
            Layer::Timing,
            &[field!("mcycles", u8), field!("tcycles", u8)],
        ),
    ],
};
    ...
    layers: &[
        ...
        (
            ...
            &[
                ...
                field!("pal_pipe", u8),
                // fetcher
                field!("tfetch_state", u8, dict),
                field!("sfetch_state", u8, dict),
                field!("tile_temp_a", u8),
                field!("tile_temp_b", u8),
                // counters/flags
                field!("pix_count", u8),
                field!("sprite_count", u8),
                field!("scan_count", u8),
        ...
        (
            Layer::Output,
            &[field!("pix", str, nullable), field!("pix_x", u8)],
        ),
    ],
};
    ...
    layers: &[
        (
            ...
            &[
                ...
                field!("ch1_sweep", u8),
                field!("ch1_duty_len", u8),
                field!("ch1_vol_env", u8),
                field!("ch1_freq_lo", u8),
                field!("ch1_freq_hi", u8),
                // Channel 2 — square
                field!("ch2_duty_len", u8),
                field!("ch2_vol_env", u8),
                field!("ch2_freq_lo", u8),
                field!("ch2_freq_hi", u8),
                // Channel 3 — wave
                field!("ch3_dac", u8),
                field!("ch3_len", u8),
                field!("ch3_vol", u8),
                field!("ch3_freq_lo", u8),
                field!("ch3_freq_hi", u8),
                // Channel 4 — noise
                field!("ch4_len", u8),
                field!("ch4_vol_env", u8),
                field!("ch4_freq", u8),
                field!("ch4_control", u8),
                // Control
                field!("master_vol", u8),
                field!("sound_pan", u8),
                field!("sound_on", u8),
...
pub static INTERRUPT: SubsystemDef = SubsystemDef {
    name: "interrupt",
    layers: &[
        (Layer::Registers, &[field!("if_", u8), field!("ie", u8)]),
...
pub static SERIAL: SubsystemDef = SubsystemDef {
    name: "serial",
    layers: &[(Layer::Registers, &[field!("sb", u8), field!("sc", u8)])],
};

/// CGB-only state, layered on top of the shared DMG subsystems. This is an
/// adapter-side legacy fallback table — missingno's own traces are
/// self-describing (they carry `field_defs`), so this list types only
/// pre-`field_defs` traces and non-missingno CGB adapters. Its fields are not
/// bound to missingno-gbc's tracer and may drift from it; whether to keep,
/// prune, or extend the table is a strategy call for the maintainers.
...
pub static CGB: SubsystemDef = SubsystemDef {
    ...
    layers: &[(
        ...
        &[
            ...
            field!("hdma1", u8),
            field!("hdma2", u8), // HDMA source hi/lo
            field!("hdma3", u8),
            field!("hdma4", u8),       // HDMA dest hi/lo
...
pub static SUBSYSTEMS_DMG: &[&SubsystemDef] = &[&CPU, &PPU, &APU, &TIMER, &INTERRUPT, &SERIAL];
