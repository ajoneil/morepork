...
BANNER = "// Generated by adapters/genpalette.py — do not edit. Canonical VCS\n" \
         "// NTSC/PAL palettes (Stella ourNTSC/ourPALPalette). Each 256*3 bytes,\n" \
         "// index = TIA colour byte; even = colour, odd = black (bit 0 ignored).\n"
...
print("wrote NTSC+PAL palettes to gopher2600/, mame/ (.go) and stella/ (.h)")
